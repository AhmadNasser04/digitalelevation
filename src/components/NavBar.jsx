  ...
  return (
    <div className="shadow-md w-full top-0 left-0 fixed z-10">
      <div className="md:flex items-center justify-evenly bg-[#1f2227] py-4 md:px-10 px-7">
        ...
        <ul
          className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in bg-[#1f2227] md:bg-transparent ${
